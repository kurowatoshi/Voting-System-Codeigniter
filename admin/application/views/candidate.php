<div class="row">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" action="<?=base_url('admin/tambah_candidate');?>">
    ...
    <div class="col-sm-12">
        <div class="tengah">
            <div class="col-sm-12">
                <h3 class="text-center">Lists of Candidates</h3>
            </div>
        <?php
        if (count($kandidat) > 0) {
            ...
            <div class="col-sm-4">
                <div class="box box-success">
                    <div class="box-header">
                        <?php if ($k->id_candidate_participation): ?>
                    ...
                    <div class="box-body box-profile">
                        <img src="<?=base_url('./../assets/img/kandidat/'.$k->photo);?>" alt="" class="profile-user-img img-responsive img-kandidat img-circle">
                        <h3 class="profile-username text-center"><?=$k->candidate_name;?></h3>
                        <p class="text-muted text-center"><?=$k->description;?></p>
...
<script>
    $(document).ready(function(){
        $('.hapus').on('click', function(){
            ...
            if (h) {
                window.location.assign('<?=base_url("admin/hapus_candidate/");?>'+id);
            }
            return false;
        });
        $('.edit').on('click', function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('[name="ket"]').val(data.description);
                    var foto = '<img class="img-circle img-responsive img-kandidat" src="'+base_url+'./../assets/img/kandidat/'+data.photo+'">';
