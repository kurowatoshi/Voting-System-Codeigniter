            ...
            <div class="box-body">
                <form action="<?=base_url('admin/ganti_user_admin/'.$this->session->id)?>" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="<?=$this->session->name;?>" class="form-control" placeholder="Enter Administrator Name" required>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formTambah">
                    <div class="form-group">
                        <label for="Nama">Name :</label>
                        <input type="text" name="name" class="form-control" placeholder="Enter Administrator Name">
                    </div>
                    <div class="form-group">
                        <label for="Username">Username :</label>
