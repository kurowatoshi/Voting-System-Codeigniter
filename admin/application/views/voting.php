                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="kandidat[]" class="form-control select2" data-placeholder="Select Candidates (Multiple)" multiple="multiple" style="width: 100%;" required="required">
                                    ...
                                    <option value="<?=$lk->id_candidate;?>"><?=$lk->candidate_name;?></option>
                                    <?php endforeach;?>
                                </select>
    ...
    <?php else: ?>
        <div class="col-sm-12">
            <div class="box box-success">
                <div class="box-body">
                    <h2 class="text-center"><?=$voting->voting_name;?></h2>
                    <hr>
                        ...
                        <div class="col-sm-4">
                            <div class="box box-success">
                                <div class="box-body box-profile">
                                    <img src="<?=base_url('./../assets/img/kandidat/'.$k->photo);?>" alt="" class="profile-user-img img-kandidat img-responsive img-circle">
                                    <h3 class="profile-username text-center"><?=$k->candidate_name;?></h3>
                                    <p class="text-muted text-center"><?=$k->description;?></p>
                                    <h3 class="text-center"><span class="label label-danger">Points : <?=$k->points?></span></h3>
                                </div>
                            </div>
                        </div>
                    <?php endforeach;?>
                        ...
                        <form action="<?=base_url('admin/edit_voting/'.$voting->id_voting);?>" method="POST">
                            <div class="form-group">
                                <label for="NamaVoting">Name Voting :</label>
                                    <input type="text" name="voting" class="form-control" value="<?=$voting->voting_name;?>" placeholder="Enter Voting Name" required="required">
                            </div>
                            <!-- <div class="form-group">
